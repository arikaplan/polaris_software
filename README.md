...
Atmospheric emmission modeled with ATMOS32 and plotted against foreground spectral behavior with data simulated using PySM3 for the planck sky model (https://github.com/arikaplan/polaris_software/blob/master/notebook/atmospheric%20plot.ipynb)
...
(https://github.com/arikaplan/polaris_software/blob/master/notebook/Sky_dip.ipynb)
...
Measuring the rise and fall of crab nebula through our rotating beam, then binning to celestial coordinates to measure offsets in our pointing calibration (https://github.com/arikaplan/polaris_software/blob/master/notebook/pointing_cal.ipynb)
