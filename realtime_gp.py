...
def pointing_plot(var,vector,gpstime):
	...
	plt.plot(t,vector,label=str(var))
	plt.xlabel('%s since start time' % l)
	if var == 'az' or var == 'el' or var == 'x tilt' or var == 'y tilt':
	   unit = 'deg'
	elif var == 'H1' or var== 'H2' or var == 'H3':
	   unit = 'V'
	elif var == 'Phidget Temp':
		unit = 'C'
	elif var == 'gpstime':
		unit = ''
	else:
